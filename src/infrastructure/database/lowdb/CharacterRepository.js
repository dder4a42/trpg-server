...
export class CharacterRepository {
    ...
    async update(id, character) {
        ...
        if (character.maxHp !== undefined)
            updated.max_hp = character.maxHp;
        if (character.currentHp !== undefined)
            updated.current_hp = character.currentHp;
        if (character.tempHp !== undefined)
            updated.temp_hp = character.tempHp;
        ...
        if (character.isDead !== undefined)
            updated.is_dead = character.isDead ? 1 : 0;
        ...
        if (character.savingThrowProficiencies !== undefined)
            updated.saving_throw_proficiencies = JSON.stringify(character.savingThrowProficiencies);
        ...
        if (character.languageProficiencies !== undefined)
            updated.language_proficiencies = JSON.stringify(character.languageProficiencies);
