 ...
 */
export const UNCONSCIOUS_CONDITIONS = [
    'unconscious',
    'incapacitated',
    'paralyzed',
    'stunned',
 ...
 */
export const NO_ACTION_CONDITIONS = [
    'incapacitated',
    'paralyzed',
    'petrified',
    'stunned',
