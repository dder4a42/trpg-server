...
router.patch('/:id', asyncHandler(async (req, res) => {
    ...
    if (updates.name !== undefined)
        partialUpdate.name = updates.name;
    if (updates.race !== undefined)
        partialUpdate.race = updates.race;
    if (updates.characterClass !== undefined)
        partialUpdate.characterClass = updates.characterClass;
    if (updates.level !== undefined)
        partialUpdate.level = updates.level;
    if (updates.background !== undefined)
        partialUpdate.background = updates.background;
    if (updates.alignment !== undefined)
        partialUpdate.alignment = updates.alignment;
    if (updates.abilityScores !== undefined)
        partialUpdate.abilityScores = updates.abilityScores;
    if (updates.appearance !== undefined)
        partialUpdate.appearance = updates.appearance;
    if (updates.personalityTraits !== undefined)
        partialUpdate.personalityTraits = updates.personalityTraits;
    if (updates.backstory !== undefined)
        partialUpdate.backstory = updates.backstory;
