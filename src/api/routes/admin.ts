...
router.post('/users/:id/deactivate', asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const db = DatabaseService.getInstance();
...
router.post('/users/:id/activate', asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const db = DatabaseService.getInstance();
...
router.get('/rooms', asyncHandler(async (_req: AuthenticatedRequest, res: Response) => {
  const db = DatabaseService.getInstance();
...
router.post('/rooms/:id/close', asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const db = DatabaseService.getInstance();
...
router.post('/rooms/:id/delete', asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const db = DatabaseService.getInstance();
...
router.get('/rooms/:id', asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const db = DatabaseService.getInstance();
...
router.get('/characters', asyncHandler(async (_req: AuthenticatedRequest, res: Response) => {
  const db = DatabaseService.getInstance();
...
router.post('/characters/:id/delete', asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const db = DatabaseService.getInstance();
