...
import type { IRoom, User } from '@/domain/index.js';
import { DatabaseService } from '@/infrastructure/database/DatabaseService.js';
import type { broadcastChatMessage } from './streaming.js';
...
let broadcastFn: typeof broadcastChatMessage;
 ...
 */
export function setChatReferences(
  getRoomsFn: () => Map<string, IRoom>,
  broadcast: typeof broadcastChatMessage
): void {
